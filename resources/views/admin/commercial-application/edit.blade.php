                    ...
                    <form onsubmit="ajaxStore(event, this)" action="{{ route('commercial-application.store') }}" method="POST"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Industrial"
                                        id="property_type1" {{ $com->property_type == 'Industrial' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Office Space"
                                        id="property_type2" {{ $com->property_type == 'Office Space' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Warehouse"
                                        id="property_type3" {{ $com->property_type == 'Warehouse' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Other"
                                        id="property_type4" {{ $com->property_type == 'Other' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Restaurant"
                                        id="property_type5" {{ $com->property_type == 'Restaurant' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Building"
                                        id="property_type6" {{ $com->property_type == 'Building' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="property_type" value="Retail"
                                        id="property_type7" {{ $com->property_type == 'Retail' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="property_description" class="form-control" rows="5">{{ $com->property_description }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="parking" value="Yes"
                                        id="parking1" {{ $com->parking == 'Yes' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="parking1">
                                        Yes
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="parking" value="No"
                                        id="parking2" {{ $com->property_type == 'No' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="parking2">
                                        No
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="parking" value="Other"
                                        id="parking3" {{ $com->property_type == 'Other' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="lease_start_date" class="form-label">When is the lease term start date?
                                    *</label>
                                <input type="date" name="lease_start_date" class="form-control"
                                    value="{{ $com->lease_start_date }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_term" value="Monthly"
                                        id="payment_term1" {{ $com->payment_term == 'Monthly' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_term" value="Yearly"
                                        id="payment_term2" {{ $com->payment_term == 'Yearly' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_term" value="Quarterly"
                                        id="payment_term3" {{ $com->payment_term == 'Quarterly' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_term" value="Other"
                                        id="payment_term4" {{ $com->payment_term == 'Other' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pay_method" value="Cash"
                                        id="pay_method1" {{ $com->pay_method == 'Cash' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pay_method" value="Credit Card"
                                        id="pay_method2" {{ $com->pay_method == 'Credit Card' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <label for="taxes" class="form-label">Who is responsible for paying the property taxes?
                                    *</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="taxes" value="Landlord"
                                        id="taxes1" {{ $com->taxes == 'Landlord' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="taxes1">
                                        Landlord
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="taxes" value="Tenant"
                                        id="taxes2 {{ $com->taxes == 'Tenant' ? 'checked' : '' }}">
                            ...
                            <div class="col-md-6">
                                <label for="responsible" class="form-label">Who will be responsible for the maintenance
                                    and repair of
                                    the
                                    property? *</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="responsible" value="Landlord"
                                        id="responsible1" {{ $com->responsible == 'Landlord' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="responsible" value="Tenant"
                                        id="responsible2" {{ $com->responsible == 'Tenant' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="utilities" value="Landlord"
                                        id="utilities1" {{ $com->utilities == 'Landlord' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="utilities1">
                                        Landlord
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="utilities" value="Tenant"
                                        id="utilities2" {{ $com->utilities == 'Tenant' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <label for="insurance" class="form-label">Who will pay for the property insurance?
                                    *</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="insurance" value="Landlord"
                                        id="insurance1" {{ $com->insurance == 'Landlord' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="insurance1">
                                        Landlord
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="insurance" value="Tenant"
                                        id="insurance2" {{ $com->insurance == 'Tenant' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <label for="furniture" class="form-label">Are there utilities and furniture included in
                                    the property?
                                    If yes, please list them below:</label>
                                <textarea name="furniture" class="form-control" rows="10">{{ $com->furniture }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phone" class="form-control" value="{{ $com->phone }}">
                                @if ($errors->has('phone'))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control" value="{{ $com->email }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="address" class="form-control" value="{{ $com->address }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="city" class="form-control" value="{{ $com->city }}">
                                @if ($errors->has('city'))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="state" class="form-control" value="{{ $com->state }}">
                                @if ($errors->has('state'))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="post" class="form-control" value="{{ $com->post }}">
                                @if ($errors->has('post'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="agreement_date" class="form-control"
                                    value="{{ $com->agreement_date }}">
                                @if ($errors->has('agreement_date'))
                                    <div class="alert alert-danger">{{ $errors->first('agreement_date') }}</div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <label for="guarantee_lease" class="form-label">Persons who will guarantee the lease
                                    *</label>
                                <input name="guarantee_lease" class="form-control" value="{{ $com->guarantee_lease }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="question" class="form-control" rows="6">{{ $com->question }}</textarea>
