    ...
    <section class="latestPostsBlock container" style="margin-top: 40px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="pay_method" value="Cash" id="pay_method1">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="pay_method" value="Check" id="pay_method4">
