            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col isoCol sale">
                    ...
                    <article class="postColumn hasOver bgWhite">
                        ...
                        <h2 class="fontNeuron text-capitalize"><a href="properties-single1.html">4 Bedroom New House For
                                Sale</a></h2>
                        <address>
                            <span class="icn"><i class="fi flaticon-pin-1"></i></span>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col isoCol rent">
                    ...
                    <article class="postColumn hasOver bgWhite">
                        ...
                        <h2 class="fontNeuron text-capitalize"><a href="properties-single1.html">Elegant studio flat</a>
                        </h2>
                        <address>
                            <span class="icn"><i class="fi flaticon-pin-1"></i></span>
                            <p>The Village, Jersey City, NJ 07302, USA </p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col isoCol sale">
                    ...
                    <article class="postColumn hasOver bgWhite" data-label="featured">
                        ...
                        <h2 class="fontNeuron text-capitalize"><a href="properties-single1.html">Full Floor Office
                                Condo</a></h2>
                        <address>
                            <span class="icn"><i class="fi flaticon-pin-1"></i></span>
                            <p>London, United Kingdom </p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col isoCol rent">
                    ...
                    <article class="postColumn hasOver bgWhite">
                        ...
                        <h2 class="fontNeuron text-capitalize"><a href="properties-single1.html">Villa on Hollywood
                                Boulevard</a></h2>
                        <address>
                            <span class="icn"><i class="fi flaticon-pin-1"></i></span>
                            <p>778 Country St. Panama City, FL</p>
